...
\myexternaldocument{0Main-Feb2022}
...
{\it Proof of Lemma \ref{Alemma3}:} 
	...
	\ST{it converges to $\mathbb{R}^{p}$ for any fixed $v$ with probability one}. Then $\int_{Q_{v}}t''N\{t'';0,\tau(\theta_{0})^{-1}\}\,dt''=o_{P}(1)$
...
\begin{lemma}\label{Alemma7} \ST{Results generalizing Lemma 10 in ~\cite{Li2017}}
	hold. \end{lemma}
{\it Proof of Lemma \ref{Alemma7}:} 
