...
\usepackage{microtype} %to wrap long citations on multiple lines rather than overshooting the margin
...
\renewcommand\@biblabel[1]{} %%to get rid of bibitem labels in []'s 
\makeatother
...
%%%TO DO: define the rate of convergence $\Theta_p(\cdot)$
